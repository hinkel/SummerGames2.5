...
//    dTf  = (float)ms5611_ut - ((float)ms5611_c[5] * 256.0f); // Summergames 2.4
//    temp = 2000 + (int32_t)(((int64_t)dTf * (int64_t)ms5611_c[6]) >> 23);
//    off  = (int64_t)((uint32_t)ms5611_c[2] << 16) + ((dTf * (float)ms5611_c[4]) / 128.0f);
//    sens = (int64_t)((uint32_t)ms5611_c[1] << 15) + ((dTf * (float)ms5611_c[3]) / 256.0f);
